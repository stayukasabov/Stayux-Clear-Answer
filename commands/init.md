---
name: init
description: Add a concise Clear Answer (plain-English) rules section to the project's CLAUDE.md so every session writes to the standard.
---
...
3. Append a short section titled "Clear Answer (plain-English rules)" that:
   ...
   - Tells the reader to check drafts with the `/clear-answer:check` command or
